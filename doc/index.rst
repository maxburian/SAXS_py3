...
The SAXS python package implements analysis tools for Small Angle X-Ray Scattering (SAXS) data analysis.
...
The SAXS module consists of a Pyhon library and 3 command line tools: :ref:`saxsdog`, :ref:`plotchi` 
and :ref:`converter`
